  ...
  module Lexers
    class COBOL < RegexLexer
      ...
      KEYWORDS = %w[
        ...
        COMMON COMMUNICATION COMP COMP-1 COMP-2 COMP-3 COMP-4 COMP-5 COMPUTATIONAL COMPUTATIONAL-1 COMPUTATIONAL-2
        COMPUTATIONAL-3 COMPUTATIONAL-4 COMPUTATIONAL-5 COMPUTE CONDITION CONSTANT CONTAINS CONTENT
        ...
        DESCENDING DESTINATION DETAIL DISABLE DISPLAY DISPLAY-1 DIVIDE DOWN DUPLICATES DYNAMIC EC EGCS EGI
        EJECT ELSE EMI ENABLE END END-ACCEPT END-ADD END-CALL END-COMPUTE END-DELETE END-DISPLAY END-DIVIDE END-EVALUATE
        END-EXEC END-IF END-INVOKE END-JSON END-MULTIPLY END-OF-PAGE END-PERFORM END-READ END-RECEIVE END-RETURN
        END-REWRITE END-SEARCH END-START END-STRING END-SUBTRACT END-UNSTRING END-WRITE END-XML ENDING ENTER ENTRY
        ...
        HEADING HIGH-VALUE HIGH-VALUES I-O I-O-CONTROL ID IF IN INDEX INDEXED INDICATE INHERITS INITIAL
        ...
        PROCEDURE-POINTER PROCEDURES PROCEED PROCESSING PROGRAM PROGRAM-ID PROGRAM-POINTER PROPERTY PROTOTYPE
        ...
        SEPARATE SEQUENCE SEQUENTIAL SERVICE SET SHARING SHIFT-IN SHIFT-OUT SIGN SIZE SKIP1 SKIP2 SKIP3 SORT
        SORT-CONTROL SORT-CORE-SIZE SORT-FILE-SIZE SORT-MERGE SORT-MESSAGE SORT-MODE-SIZE SORT-RETURN SOURCE
        SOURCE-COMPUTER SOURCES SPACE SPACES SPECIAL-NAMES SQL SQLIMS STANDARD STANDARD-1 STANDARD-2 START STATUS STOP
        ...
        WRITE WRITE-ONLY XML XML-CODE XML-EVENT XML-INFORMATION XML-NAMESPACE XML-NAMESPACE-PREFIX
        XML-NNAMESPACE XML-NNAMESPACE-PREFIX XML-NTEXT XML-SCHEMA XML-TEXT ZERO ZEROES ZEROS
      ]
