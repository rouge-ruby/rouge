...
module Rouge
  module Lexers
    class FreeFem < RegexLexer
      ...
      def self.builtins
        @builtins ||= Set.new %w(
          abs acos acosh adaptmesh adj AffineCG AffineGMRES arg asin asinh assert atan atan2 atanh atof atoi
      ...
      def self.builtinsParameters
        @builtinsParameters ||= Set.new %w(
          A A1 abserror absolute aniso aspectratio
      ...
      state :statements do
        ...
        rule id do |m|
          ...
          if self.class.keywords.include? name
            ...
            token Name::Builtin
          elsif self.class.builtinsParameters.include? name
