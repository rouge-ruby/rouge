    ...
    class HLSL < C
      ...
      def self.keywords
        @keywords ||= Set.new %w(
          ...
          technique11 texture typedef triangle
      ...
      def self.builtins
        @builtins ||= Set.new %w(
          ...
          BLENDWEIGHT0 BLENDWEIGHT1 BLENDWEIGHT2 BLENDWEIGHT3 BLENDWEIGHT4
          ...
          PSIZE0 PSIZE1 PSIZE2 PSIZE3 PSIZE4
          TANGENT TANGENT0 TANGENT1 TANGENT2 TANGENT3 TANGENT4
          TESSFACTOR0 TESSFACTOR1 TESSFACTOR2 TESSFACTOR3 TESSFACTOR4
