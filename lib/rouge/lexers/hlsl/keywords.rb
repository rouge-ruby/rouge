  ...
  module Lexers
    class HLSL
      ...
      KEYWORDS_TYPE = Set.new %w(
        ...
        bool bool1 bool2 bool3 bool4 BOOL1 BOOL2 BOOL3 BOOL4
        ...
        uint1x1 uint1x2 uint1x3 uint1x4 uint2x1 uint2x2 uint2x3 uint2x4
        uint3x1 uint3x2 uint3x3 uint3x4 uint4x1 uint4x2 uint4x3 uint4x4
      ...
      RESERVED = Set.new %w(
        ...
        reinterpret_cast short signed sizeof static_cast this throw
        try union unsigned using virtual
      )
      ...
      BUILTINS = Set.new %w(
        ...
        TESSFACTOR2 TESSFACTOR3 TESSFACTOR4 TEXCOORD TEXCOORD0 TEXCOORD1 TEXCOORD2
        TEXCOORD3 TEXCOORD4
