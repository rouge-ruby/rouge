  ...
  module Lexers
    class Isabelle < RegexLexer
      ...
      state :root do
        ...
        rule word(keyword_minor), Keyword::Pseudo
        rule word(keyword_diag), Keyword::Type
        rule word(keyword_thy), Keyword
        rule word(keyword_theory_decl), Keyword
        rule word(keyword_section), Generic::Heading
        rule word(keyword_subsection), Generic::Subheading
        rule word(keyword_theory_goal), Keyword::Namespace
        rule word(keyword_theory_script), Keyword::Namespace
        rule word(keyword_abandon_proof), Generic::Error
        rule word(keyword_qed), Keyword
        rule word(keyword_proof_goal), Keyword
        rule word(keyword_proof_block), Keyword
        rule word(keyword_proof_decl), Keyword
        rule word(keyword_proof_chain), Keyword
        rule word(keyword_proof_asm), Keyword
        rule word(keyword_proof_asm_goal), Keyword
        rule word(keyword_proof_script), Keyword::Pseudo
