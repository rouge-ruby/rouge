      ...
      state :proc do
        ...
        rule /\w[\w\d]*/ do |m|
          if self.class.data_step_statements.include? m[0].upcase
            ...
            token Keyword
          elsif PROC_KEYWORDS.has_key?(@proc_name) and PROC_KEYWORDS[@proc_name].include? m[0].upcase
            token Keyword
          else
            token Name
          end
