    ...
    class SQL < RegexLexer
      ...
      def self.keywords
        @keywords ||= Set.new %w(
          ...
          CLASS CLASS_ORIGIN CLOB CLOSE CLUSTER COALSECE COBOL
          ...
          SERVER_NAME SESSION SESSION_USER SETOF SETS SHARE SHOW
      ...
      def self.keywords_type
        ...
        @keywords_type ||= Set.new(%w(
            ...
            NATIONAL CHAR CHARACTER SET COLLATE NCHAR BYTE
