...
module Rouge
  module Lexers
    class Stan < RegexLexer
      ...
      KEYWORDS = Set.new %w(if else while for break continue print reject return)

      TYPES = Set.new %w(
        int real vector ordered positive_ordered simplex unit_vector row_vector
        matrix cholesky_factor_corr cholesky_factor_cov corr_matrix cov_matrix
        data void
      )
      ...
      BUILTIN_FUNCTIONS = [
        ...
        "sqrt", "cbrt", "square", "exp", "exp2", "log", "log2", "log10", "pow",
        "inv", "inv_sqrt", "inv_square",
        ...
        "beta", "inc_beta", "lbeta", "tgamma", "lgamma", "digamma", "trigamma",
        "lmgamma", "gamma_p", "gamma_q", "binomial_coefficient_log", "choose",
        ...
        ## Composed functions
        "expm1", "fma", "multiply_log", "ldexp", "lmultiply", "log1p", "log1m",
        "log1p_exp", "log1m_exp", "log_diff_exp", "log_mix", "log_sum_exp",
        "log_inv_logit", "log_inv_logit_diff", "log1m_inv_logit",
        ...
        "one_hot_vector", "one_hot_row_vector", "ones_int_array", "ones_array",
        "ones_vector", "ones_row_vector", "zeros_int_array", "zeros_array",
        "zeros_vector", "zeros_row_vector", "uniform_simplex",
        ...
        "csr_extract_w", "csr_extract_v", "csr_extract_u", "csr_to_dense_matrix",

        ## Sparse matrix arithmetic
        "csr_matrix_times_vector",

        # Mixed Operations
        "to_matrix", "to_vector", "to_row_vector", "to_array_2d", "to_array_1d",
      ...
      DISTRIBUTIONS = [
        ...
        "skew_normal", "student_t", "cauchy", "double_exponential", "logistic",
        "gumbel", "skew_double_exponential",
        ...
        "multi_gp", "multi_gp_cholesky", "multi_student_t", "gaussian_dlm_obs",
      ...
      state :statements do
        ...
        rule ID do |m|
          ...
          if KEYWORDS.include? name
            ...
            token Keyword::Type
          elsif OPERATORS.include? name
            token Operator
          elsif RESERVED.include? name
            token Keyword::Reserved
          elsif ["lower", "upper"].include? name
      ...
      state :scope do
        ...
        rule %r(
          ...
          recurse m[1]
          if BUILTIN_FUNCTIONS.include? m[2]
            token Name::Builtin, m[2]
          elsif DISTRIBUTIONS.include? m[2]
            token Name::Builtin, m[2]
          elsif CONSTANTS.include? m[2]
