...
module Rouge
  module Themes
    class Github < CSSTheme
      ...
      style Comment::Single,                  :fg => '#555555', :italic => true
      style Comment::Special,                 :fg => '#999999', :italic => true, :bold => true
      style Comment,                          :fg => '#555555', :italic => true
      ...
      style Literal::String::Double,          :fg => '#000080'
      ...
      style Literal::String::Single,          :fg => '#000080'
      style Literal::String::Symbol,          :fg => '#990073'
      style Literal::String,                  :fg => '#000080'
      style Name::Attribute,                  :fg => '#008080'
      style Name::Builtin::Pseudo,            :fg => '#999999'
      style Name::Builtin,                    :fg => '#000080', :bold => true
