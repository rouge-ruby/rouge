...
<table class="rouge-line-table">
  <tbody>
    <tr id="line-1" class="lineno">
      <td class="rouge-gutter gl" aria-hidden="true" style="#{cell_style}"><pre>1</pre></td>
...
<table class="rouge-line-table">
  <tbody>
    ...
    <tr id="line-2" class="lineno">
      <td class="rouge-gutter gl" aria-hidden="true" style="#{cell_style}"><pre>2</pre></td>
      <td class="rouge-code"><pre><span class="n">bar</span>\n</pre></td>
    </tr>
    <tr id="line-3" class="lineno">
      <td class="rouge-gutter gl" aria-hidden="true" style="#{cell_style}"><pre>3</pre></td>
      <td class="rouge-code"><pre>foo\n</pre></td>
    </tr>
    <tr id="line-4" class="lineno">
      <td class="rouge-gutter gl" aria-hidden="true" style="#{cell_style}"><pre>4</pre></td>
...
<table class="code-table">
  <tbody>
    <tr id="L15" class="line-no">
      <td class="code-gutter gl" aria-hidden="true" style="#{cell_style}"><pre>15</pre></td>
