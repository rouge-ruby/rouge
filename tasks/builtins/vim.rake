...
def render_keywords(keywords, &b)
  ...
  yield '# see tasks/builtins/vim.rake for more info.'
  yield 'module Rouge'
  yield '  module Lexers'
  yield '    class VimL'
...
def vim_keywords
  syntax_uri = "https://raw.githubusercontent.com/vim/vim/master/runtime/syntax/vim.vim"
  out = nil

  URI.open(syntax_uri) do |f|
